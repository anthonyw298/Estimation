...
def calculate_yes45tu_quantities(
    ...
    outputs = { 
        ...
        "BE9-2513": calculate_sill_ft_h(opening_width, total_count),                                               # Sill/Jamb Screw Spline Assembly (horizontal) — note duplicate key issue here
    ...
    for part_number, quantity in outputs.items():
        desc = None
        part_type = None
